!function(window, document, undefined) {
    ...
    function createPredicateFn(expression, comparator, matchAgainstAnyProp) {
        ...
        return comparator === !0 ? comparator = equals : isFunction(comparator) || (comparator = function(actual, expected) {
            return isUndefined(actual) ? !1 : null === actual || null === expected ? actual === expected : isObject(actual) || isObject(expected) ? !1 : (actual = lowercase("" + actual), 
            ...
            link: function(scope, element, attr, ctrls) {
                function setupAsSingle(scope, selectElement, ngModelCtrl, selectCtrl) {
                    ngModelCtrl.$render = function() {
                        ...
                        selectElement.val(viewValue), "" === viewValue && emptyOption.prop("selected", !0)) : null == viewValue && emptyOption ? selectElement.val("") : selectCtrl.renderUnknownOption(viewValue);
...
function(window, angular, undefined) {
    ...
    "use strict";
    var b = a.module("ngDialog", []), c = a.element, d = a.isDefined, e = (document.body || document.documentElement).style, f = d(e.animation) || d(e.WebkitAnimation) || d(e.MozAnimation) || d(e.MsAnimation) || d(e.OAnimation), g = "animationend webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend", h = "a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]", i = "ngdialog-disabled-animation", j = !1, k = {}, l = [], m = !1;
            ...
            var B = {
                ...
                performCloseDialog: function(a, b) {
                    ...
                    if (h) {
                        ...
                        j && j.focus(), u.$broadcast("ngDialog.closing", a, b), n = 0 > n ? 0 : n, f && !c.disableAnimation ? (h.$destroy(), 
                        a.unbind(g).bind(g, function() {
                            a.remove(), 0 === n && (z.removeClass("ngdialog-open"), B.resetBodyPadding()), u.$broadcast("ngDialog.closed", a, b);
                        }).addClass("ngdialog-closing")) : (h.$destroy(), a.remove(), 0 === n && (z.removeClass("ngdialog-open"), 
                        B.resetBodyPadding()), u.$broadcast("ngDialog.closed", a, b)), o[e] && (o[e].resolve({
                            id: e,
                            value: b,
                            $dialog: a,
                            remainingDialogs: n
                        }), delete o[e]), k[e] && delete k[e], l.splice(l.indexOf(e), 1), l.length || (z.unbind("keydown", B.onDocumentKeydown), 
                        m = !1);
                    }
                },
                ...
                getFocusableElements: function(a) {
                    var b = a[0], c = b.querySelectorAll(h);
                ...
                applyAriaAttributes: function(a, b) {
                    ...
                    b.ariaRole && a.attr("role", b.ariaRole), B.applyAriaAttribute(a, "aria-labelledby", b.ariaLabelledById, b.ariaLabelledBySelector), 
                    B.applyAriaAttribute(a, "aria-describedby", b.ariaDescribedById, b.ariaDescribedBySelector);
                },
                ...
                open: function(f) {
                    ...
                    var j = a.copy(b), p = ++e, A = "ngdialog" + p;
                    ...
                    return a.forEach(H, function(b, c) {
                        ...
                        if (j.showClose && (e += '<div class="ngdialog-close"></div>'), F = c('<div id="ngdialog' + p + '" class="ngdialog"></div>'), 
                        F.html(j.overlay ? '<div class="ngdialog-overlay"></div><div class="ngdialog-content" role="document">' + e + "</div>" : '<div class="ngdialog-content" role="document">' + e + "</div>"), 
                        F.data("$ngDialogOptions", j), E.ngDialogId = A, j.data && a.isString(j.data)) {
                        ...
                        if (j.className && F.addClass(j.className), j.disableAnimation && F.addClass(i), 
                        G = j.appendTo && a.isString(j.appendTo) ? a.element(document.querySelector(j.appendTo)) : z, 
                        B.applyAriaAttributes(F, j), j.preCloseCallback) {
                            var l;
                            a.isFunction(j.preCloseCallback) ? l = j.preCloseCallback : a.isString(j.preCloseCallback) && E && (a.isFunction(E[j.preCloseCallback]) ? l = E[j.preCloseCallback] : E.$parent && a.isFunction(E.$parent[j.preCloseCallback]) ? l = E.$parent[j.preCloseCallback] : u && a.isFunction(u[j.preCloseCallback]) && (l = u[j.preCloseCallback])), 
                            l && F.data("$ngDialogPreCloseCallback", l);
                        }
                        if (E.closeThisDialog = function(a) {
                            ...
                            c > 0 && B.setBodyPadding(c), G.append(F), B.activate(F), j.trapFocus && B.autoFocus(F), 
                            j.name ? u.$broadcast("ngDialog.opened", {
                                dialog: F,
                                name: j.name
                        ...
                        if (j.preserveFocus && F.data("$ngDialogPreviousFocus", document.activeElement), 
                        d = function(a) {
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var offset, _mx, _my, _tx, _ty, _mrx, _mry, _dragHandle, _centerAnchor = !1, _hasTouch = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch, _pressEvents = "touchstart mousedown", _moveEvents = "touchmove mousemove", _releaseEvents = "touchend mouseup", _myid = scope.$id, _data = null, _dragOffset = null, _dragEnabled = !1, _pressTimer = null, onDragStartCallback = $parse(attrs.ngDragStart) || null, onDragStopCallback = $parse(attrs.ngDragStop) || null, onDragSuccessCallback = $parse(attrs.ngDragSuccess) || null, allowTransform = angular.isDefined(attrs.allowTransform) ? scope.$eval(attrs.allowTransform) : !0, getDragData = $parse(attrs.ngDragData), _deregisterRootMoveListener = angular.noop, initialize = function() {
            ...
            }, toggleListeners = function(enable) {
                enable && (scope.$on("$destroy", onDestroy), scope.$watch(attrs.ngDrag, onEnableChange), 
                scope.$watch(attrs.ngCenterAnchor, onCenterAnchor), _dragHandle ? _dragHandle.on(_pressEvents, onpress) : element.on(_pressEvents, onpress), 
                ...
                }, 100), $document.on(_moveEvents, cancelPress), $document.on(_releaseEvents, cancelPress)) : onlongpress(evt)));
            }, cancelPress = function() {
                clearTimeout(_pressTimer), $document.off(_moveEvents, cancelPress), $document.off(_releaseEvents, cancelPress);
                ...
                _ty = _my - _mry - $window.pageYOffset), $document.on(_moveEvents, onmove), $document.on(_releaseEvents, onrelease), 
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var _lastDropTouch = null, _myid = scope.$id, _dropEnabled = !1, onDropCallback = $parse(attrs.ngDropSuccess), onDragStartCallback = $parse(attrs.ngDragStart), onDragStopCallback = $parse(attrs.ngDragStop), onDragMoveCallback = $parse(attrs.ngDragMove), initialize = function() {
                toggleListeners(!0);
            }, toggleListeners = function(enable) {
                ...
                return _dropEnabled && _myid !== obj.uid ? (isTouching(obj.x, obj.y, obj.element) && (obj.callback && obj.callback(obj), 
                attrs.ngDropSuccess && $timeout(function() {
                ...
                }), void updateDragStyles(!1, obj.element)) : void updateDragStyles(!1, obj.element);
